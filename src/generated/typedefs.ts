...
type Mutation {
  ...
  # Delete mutation for the table 'user'.
  # Note that 'user_id' is the field that corresponds to the table primary key.
  deleteuser(
    value: userInput!
    ifExists: Boolean
    ifCondition: userFilterInput
    options: MutationOptions
  ): userMutationResult

  # Insert mutation for the table 'user'.
  # Note that 'user_id' is the field that corresponds to the table primary key.
  insertuser(
    value: userInput!
    ifNotExists: Boolean
  ...
  # Update mutation for the table 'user'.
  # Note that 'user_id' is the field that corresponds to the table primary key.
  updateuser(
    value: userInput!
    ifExists: Boolean
...
# The type used to represent results of a query for the table 'user'.
type user {
  user_id: String
  email: String
  name: String
...
# The type used to represent results of a mutation for the table 'user'.
type userMutationResult {
  applied: Boolean
  value: user
}

# The enum used to order a query result based on one or more fields for the table 'user'.
enum userOrder {
  user_id_DESC
  user_id_ASC
  email_DESC
